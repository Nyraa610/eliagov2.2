...
export function MatrixContainer({ data }: MatrixContainerProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div ref={matrixContainerRef} className="bg-white p-6 rounded-lg border">
      ...
      <div className="flex justify-between items-center">
        <div className="flex gap-2">
          <ExportActions 
            onDownload={() => handleDownloadPDF(matrixContainerRef, validIssues, data.companyName)}
            onPrint={() => handlePrintMatrix(matrixContainerRef, validIssues)}
      ...
      <SaveToDeliverableDialog 
        ...
        onSave={() => handleSaveToDeliverables(matrixContainerRef, validIssues, data)}
      />
